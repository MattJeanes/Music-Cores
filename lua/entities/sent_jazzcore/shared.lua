...
ENT.Base 			= "base_core3"
ENT.PrintName		= "Smooth Jazz Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "Smooth Jazz will be deployed in.." -- The purpose of the entity
...
ENT.Dir				= "jazz" -- The name of your sub-folder, must be 4 characters.
ENT.MusicCore		= true
/*---------------------------------------------------------
