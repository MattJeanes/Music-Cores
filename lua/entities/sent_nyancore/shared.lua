...
ENT.Base 			= "base_core3"
ENT.PrintName		= "Nyan Core" -- The name the Core will come up as in the Spawnmenu
...
ENT.Purpose			= "Nyanyanyanyan." -- The purpose of the entity
...
ENT.Dir				= "nyan" -- The name of your sub-folder, must be 4 characters.
ENT.MusicCore		= true
/*---------------------------------------------------------
